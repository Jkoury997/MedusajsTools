  ...
  return (
    <div className="min-h-screen pb-8">
      ...
      <div className="mt-5 space-y-4">
        ...
        {/* Acceso a Picking por Olas */}
        <Link
          href={`/olas?store=${user.storeId}`}
          className="flex items-center gap-3 bg-white border border-gray-200 rounded-2xl shadow-sm p-4 hover:border-brand-300 transition-colors"
        >
          <span className="w-11 h-11 rounded-xl bg-brand-100 text-brand-600 flex items-center justify-center shrink-0">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 8 12 3 3 8l9 5 9-5z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v8"/></svg>
          </span>
          <div className="min-w-0 flex-1">
            <div className="font-bold text-gray-900">Picking por olas</div>
            <div className="text-xs text-gray-500">Preparar varios pedidos juntos en la mesa</div>
          </div>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </Link>
